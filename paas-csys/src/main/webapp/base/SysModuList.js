...
//	var TF_f3 = EF.getComboBox({fieldLabel:"模块类型",hiddenName:"moduType",width:comwidth,def:"V_SYS_MODU_TYPE",allowBlank:false});
	...
	//树
	TR_menu = EF.getTreePanel({tbar:[B_addNode,B_addChildNode],border:true,layout:"fit",collapseMode:"mini",split:true,region:"west",width:260,root:EF.getTreeRoot({id:"00"}),url:"/base/sysmodu/querySysModuTree?moduType=1"});
