...
//	var TF_rolecdt2 = EF.getComboBox({fieldLabel:"角色类型",hiddenName:"roleType",width:comwidth,def:"V_SYS_ROLE_ROLE_TYPE"});
	...
	//树
	TR_menu = EF.getTreePanel({tbar:EF.getToolBar({items:[B_currentRole],height:26}),border:false,layout:"fit",root:EF.getTreeRoot({id:"00"}),url:"/permis/sysmodurole/querySysModuTree?moduType=1"});
